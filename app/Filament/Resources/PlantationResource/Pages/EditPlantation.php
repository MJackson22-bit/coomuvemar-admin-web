...
class EditPlantation extends EditRecord
{
    ...
    protected static ?string $title = 'Editar Poda de formación o mantenimiento';
    ...
    {
        $url = BaseURL::$BASE_URL . 'plantation/update/' . $record['id'];
        $response = Http::put(
            url: $url,
            data: $data
        )->json();
    ...
    {
        $url = BaseURL::$BASE_URL . 'plantation/destroy/' . $record['id'];
